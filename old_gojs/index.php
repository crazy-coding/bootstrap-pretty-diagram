...
<head>
  ...
  <script id="code">
    function init() {
      ...
      loadMysql(myDiagram);  // load an initial diagram from some JSON text
    } // end init
...
<div id="sample">
  ...
  <button id="SaveButton" onclick="saveMysql()">Save</button>
  <button onclick="loadMysql()">Load</button>
  <button onclick="printDiagram()" style="">Print Diagram Using SVG</button>
</div>

  <div class="" id="app">
    <div class="diag">
      <div class="palette-div" id="palette_div">

      </div>
      <div class="diagram-div" id="diagram_div">
